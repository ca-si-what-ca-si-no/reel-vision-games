            ...
            <div className="xl:col-span-3 space-y-10">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Лотерея без лишних сложностей. Игроки понимают её с первого взгляда — выбираешь числа, получаешь результат. Никакой путаницы с правилами.
                  </p>
                  <p>
                    Игроки возвращаются день за днем за честным и прозрачным геймплеем. Охват аудитории максимальный — от студентов до пенсионеров, от новичков до опытных игроков.
                  </p>
                  <p>
