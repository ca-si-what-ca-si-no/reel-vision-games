            ...
            <div className="xl:col-span-3 space-y-10">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Лотерейная игра с прозрачной математикой и настраиваемыми параметрами. 40 клеток на поле, 10 выигрышных чисел, выбор от 1 до 10 чисел игроком.
                  </p>
                  <p>
                    Ключевая особенность — динамические коэффициенты выплат. Игрок сам выбирает уровень риска: мало чисел — частые небольшие выигрыши, много чисел — редкие крупные выплаты до <span className="text-primary font-semibold">x750</span>.
                  </p>
                  <p>
                    Provably Fair гарантирует проверяемую честность каждого раунда. Интеграция через ваш API за 3-5 дней без участия ваших разработчиков.
                  </p>
                </div>
              </div>
