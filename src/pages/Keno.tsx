            ...
            <div className="xl:col-span-3 space-y-10">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Лотерея без лишних сложностей. Игроки понимают её с первого взгляда — выбираешь числа, получаешь результат. Никаких туториалов, никакой путаницы с правилами.
                  </p>
                  <p>
                    Что делает её эффективной для вашего казино: поддержка почти не получает вопросов благодаря простоте правил. Игроки возвращаются день за днем за честным и прозрачным геймплеем. Охват аудитории максимальный — от студентов до пенсионеров, от новичков до опытных игроков.
                  </p>
                  <p>
                    Это не революция в гейминге. Это надёжный инструмент, который приносит предсказуемый доход без головной боли. Как швейцарские часы — никаких сюрпризов, просто качественно выполняет свою функцию. Максимальные выплаты до <span className="text-primary font-semibold">x750</span>.
                  </p>
                  <p>
                    Классика, которая работает всегда. Provably Fair гарантирует честность каждого раунда. Интеграция через ваш API за 3-5 дней без участия ваших разработчиков.
                  </p>
                </div>
              </div>
