...
export const kenoGameData: GameData = {
  ...
  screenshots: {
    mobile: ['/lovable-uploads/8ae2ba9a-e0ad-4bcd-a93e-b8aec9370099.png'],
    tablet: ['/lovable-uploads/8ae2ba9a-e0ad-4bcd-a93e-b8aec9370099.png'],
    desktop: ['/lovable-uploads/8ae2ba9a-e0ad-4bcd-a93e-b8aec9370099.png'],
  },
};
...
export const crashGameData: GameData = {
  ...
  screenshots: {
    mobile: ['/lovable-uploads/aa5cce58-9344-45d3-b4c0-73fb27e55af4.png'],
    tablet: ['/lovable-uploads/aa5cce58-9344-45d3-b4c0-73fb27e55af4.png'],
    desktop: ['/lovable-uploads/aa5cce58-9344-45d3-b4c0-73fb27e55af4.png'],
  },
};
...
export const hiloGameData: GameData = {
  ...
  screenshots: {
    mobile: ['/lovable-uploads/f5a02d8d-e3e0-406a-8a0c-5f95c13b0e62.png'],
    tablet: ['/lovable-uploads/f5a02d8d-e3e0-406a-8a0c-5f95c13b0e62.png'],
    desktop: ['/lovable-uploads/f5a02d8d-e3e0-406a-8a0c-5f95c13b0e62.png'],
  },
};

export const gameDataService = {
  getGameData(gameType: 'keno' | 'crash' | 'hilo'): GameData {
    switch (gameType) {
      case 'keno':
        return kenoGameData;
      case 'crash':
