...
const Hero = () => {
  return <section id="hero" className="min-h-screen flex items-center justify-center relative pt-20">
      ...
      <div className="absolute top-1/4 right-1/4 animate-float opacity-30 z-10" style={{
      animationDelay: '3s'
    }}>
        <Star className="w-5 h-5 text-accent/30" />
      </div>
      <div className="absolute bottom-1/3 left-1/3 animate-float opacity-35 z-10" style={{
      animationDelay: '3.5s'
    }}>
        <Star className="w-4 h-4 text-primary/35" />
      </div>
      <div className="absolute top-16 right-1/3 animate-float opacity-25 z-10" style={{
      animationDelay: '4s'
    }}>
        <Star className="w-3 h-3 text-accent/25" />
      </div>
      <div className="absolute bottom-20 right-1/4 animate-float opacity-40 z-10" style={{
      animationDelay: '4.5s'
    }}>
      ...
      <div className="absolute top-1/2 left-10 animate-float opacity-30 z-10" style={{
      animationDelay: '5s'
    }}>
        <Zap className="w-7 h-7 text-accent/30" />
      </div>
      <div className="absolute bottom-40 right-16 animate-float opacity-35 z-10" style={{
      animationDelay: '5.5s'
    }}>
        <Zap className="w-5 h-5 text-primary/35" />
      </div>
      <div className="absolute top-24 left-1/2 animate-float opacity-25 z-10" style={{
      animationDelay: '6s'
    }}>
