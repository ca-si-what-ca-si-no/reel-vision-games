      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          animationDelay: `${index * 0.15}s`
              ...
              {/* Content section */}
              <div className="p-6 flex flex-col flex-1 transition-all duration-500 transform-gpu group-hover:-translate-y-32">
                <div className="flex-1 space-y-4">
                  ...
                  <div className="opacity-0 transform-gpu transition-all duration-500 group-hover:opacity-100 space-y-3 absolute inset-x-6 top-24 z-10 pointer-events-none group-hover:pointer-events-auto">
